...
export const CHAPTER_DETAILS: ChapterDetails[] = [
    ...
    { number: 10, englishName: 'The Silence', transliteration: 'Yūnus', arabicName: 'يُونُс', revelationType: 'Makki', juz: '11' },
    { number: 11, englishName: 'The Stone', transliteration: 'Hūd', arabicName: 'هُود', revelationType: 'Makki', juz: '11-12' },
    { number: 12, englishName: 'The Vision of Truth', transliteration: 'Yūsuf', arabicName: 'يُوسُف', revelationType: 'Makki', juz: '12-13' },
    ...
    { number: 16, englishName: 'Pollinators', transliteration: 'An-Naḥl', arabicName: 'النَّحْل', revelationType: 'Makki', juz: '14' },
    { number: 17, englishName: 'Respite', transliteration: 'Banī Isrāʾīl', arabicName: 'الإِسْرَاء', revelationType: 'Makki', juz: '15' },
    { number: 18, englishName: 'Reserved', transliteration: 'Al-Kahf', arabicName: 'الْكَهْف', revelationType: 'Makki', juz: '15-16' },
    ...
    { number: 22, englishName: 'Life Journey', transliteration: 'Al-Ḥajj', arabicName: 'الْحَجّ', revelationType: 'Madani', juz: '17' },
    ...
    { number: 26, englishName: 'Perceiver', transliteration: 'Ash-Shuʿarāʾ', arabicName: 'الشُّعَرَاء', revelationType: 'Makki', juz: '19' },
    { number: 27, englishName: 'Fearing Workers', transliteration: 'An-Naml', arabicName: 'النَّمْل', revelationType: 'Makki', juz: '19-20' },
    { number: 28, englishName: 'Stories', transliteration: 'Al-Qaṣaṣ', arabicName: 'الْقَصَص', revelationType: 'Makki', juz: '20' },
    { number: 29, englishName: 'Weak House', transliteration: 'Al-ʿAnkabūt', arabicName: 'الْعَنْكَبُوت', revelationType: 'Makki', juz: '20-21' },
    ...
    { number: 34, englishName: 'The Lesson', transliteration: 'Sabaʾ', arabicName: 'سَبَأ', revelationType: 'Makki', juz: '22' },
    ...
    { number: 97, englishName: 'The Power', transliteration: 'Al-Qadr', arabicName: 'الْقَدْر', revelationType: 'Makki', juz: '30' },
    { number: 98, englishName: 'The Clear Evidence', transliteration: 'Al-Bayyinah', arabicName: 'الْبَيِّنَة', revelationType: 'Madani', juz: '30' },
    { number: 99, englishName: 'The Earthquake', transliteration: 'Az-Zalzalah', arabicName: 'الزَّلْزَلَة', revelationType: 'Madani', juz: '30' },
    ...
    { number: 111, englishName: 'Righteous Rope', transliteration: 'Al-Masad', arabicName: 'الْمَسَد', revelationType: 'Makki', juz: '30' },
