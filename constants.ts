...
export const TRIANGLE_POINTS: TriangleDefinition[] = [
    { name: 'Upward Triangle', color: COLORS.triangle2, points: [{ type: '3- Repent', value: 57 }, { type: '6- Purify', value: 95 }, { type: '9- Energy/Return', value: 19 }] },
    { name: 'Downward Triangle', color: COLORS.triangle1, points: [{ type: '3- Wave', value: 1 }, { type: '6- Particle', value: 39 }, { type: '9 Vibration/Fall', value: 77 }] }
];
...
export const CHAPTER_DETAILS: ChapterDetails[] = [
    ...
    { number: 4, englishName: 'The Womb-Lineage', transliteration: 'An-Nisāʾ', arabicName: 'النِّسَاء', revelationType: 'Madani', juz: '4-6' },
    ...
    { number: 8, englishName: 'The Consequence', transliteration: 'Al-Anfāl', arabicName: 'الأَنْفَال', revelationType: 'Madani', juz: '9-10' },
    ...
    { number: 12, englishName: 'Third Eye (Rushd)', transliteration: 'Yūsuf', arabicName: 'يُوسُف', revelationType: 'Makki', juz: '12-13' },
    { number: 13, englishName: 'Charged Light', transliteration: 'Ar-Raʿd', arabicName: 'الرَّعْد', revelationType: 'Madani', juz: '13' },
    { number: 14, englishName: 'Tree', transliteration: 'Ibrāhīm', arabicName: 'إِبْرَاهِيم', revelationType: 'Makki', juz: '13' },
    { number: 15, englishName: 'Stone of Return', transliteration: 'Al-Ḥijr', arabicName: 'الْحِجْر', revelationType: 'Makki', juz: '14' },
    { number: 16, englishName: "Queen's Loyalty", transliteration: 'An-Naḥl', arabicName: 'النَّحْل', revelationType: 'Makki', juz: '14' },
    ...
    { number: 21, englishName: 'Guide on Water', transliteration: 'Al-Anbiyāʾ', arabicName: 'الأَنْبِيَاء', revelationType: 'Makki', juz: '17' },
    ...
    { number: 29, englishName: 'Fragile House', transliteration: 'Al-ʿAnkabūt', arabicName: 'الْعَنْكَبُوت', revelationType: 'Makki', juz: '20-21' },
    ...
    { number: 34, englishName: 'Choice of Truth', transliteration: 'Sabaʾ', arabicName: 'سَبَأ', revelationType: 'Makki', juz: '22' },
    ...
    { number: 39, englishName: 'Faith Community', transliteration: 'Az-Zumar', arabicName: 'الزُّمَر', revelationType: 'Makki', juz: '23-24' },
    { number: 40, englishName: 'Forgiver', transliteration: 'Ghāfir', arabicName: 'غَافِر', revelationType: 'Makki', juz: '24' },
    { number: 41, englishName: 'Detangler', transliteration: 'Fuṣṣilat', arabicName: 'فُصّيلَت', revelationType: 'Makki', juz: '24-25' },
    { number: 42, englishName: 'Consultation', transliteration: 'Ash-Shūrā', arabicName: 'الشُّورَى', revelationType: 'Makki', juz: '25' },
    { number: 43, englishName: 'Kneeling Nations', transliteration: 'Az-Zukhruf', arabicName: 'الزُّخْرُف', revelationType: 'Makki', juz: '25' },
    ...
    { number: 46, englishName: 'Shifting Sands', transliteration: 'Al-Aḥqāf', arabicName: 'الأَحْقَاف', revelationType: 'Makki', juz: '26' },
    ...
    { number: 49, englishName: 'Inner Order', transliteration: 'Al-Ḥujurāt', arabicName: 'الْحُجُرَات', revelationType: 'Madani', juz: '26' },
    { number: 50, englishName: 'Knowledge', transliteration: 'Qāf', arabicName: 'ق', revelationType: 'Makki', juz: '26' },
    { number: 51, englishName: 'Explosion of Truth', transliteration: 'Adh-Dhāriyāt', arabicName: 'الذَّارِيَات', revelationType: 'Makki', juz: '26-27' },
    { number: 52, englishName: 'Promise On Mountain', transliteration: 'Aṭ-Ṭūr', arabicName: 'الطُّور', revelationType: 'Makki', juz: '27' },
    ...
    { number: 57, englishName: 'Blessing of Authority', transliteration: 'Al-Ḥadīd', arabicName: 'الْحَدِيد', revelationType: 'Madani', juz: '27' },
    ...
    { number: 65, englishName: 'The Divorce', transliteration: 'Aṭ-Ṭalāq', arabicName: 'الطَّلَاق', revelationType: 'Madani', juz: '28' },
    ...
    { number: 69, englishName: 'Truth Manifested', transliteration: 'Al-Ḥāqqah', arabicName: 'الْحَاقَّة', revelationType: 'Makki', juz: '29' },
    ...
    { number: 72, englishName: 'Transgressors', transliteration: 'Al-Jinn', arabicName: 'الْجِنّ', revelationType: 'Makki', juz: '29' },
    ...
    { number: 80, englishName: 'Turning Away', transliteration: 'ʿAbasa', arabicName: 'عَبَسَ', revelationType: 'Makki', juz: '30' },
    { number: 81, englishName: 'Implosion of Action', transliteration: 'At-Takwīr', arabicName: 'التَّكْوِير', revelationType: 'Makki', juz: '30' },
    { number: 82, englishName: 'Seal of Heaven', transliteration: 'Al-Infiṭār', arabicName: 'الإنفطار', revelationType: 'Makki', juz: '30' },
    { number: 83, englishName: 'Reductants', transliteration: 'Al-Muṭaffifīn', arabicName: 'الْمُطَفِّفِين', revelationType: 'Makki', juz: '30' },
    { number: 84, englishName: 'Quantum Threshold', transliteration: 'Al-Inshiqāq', arabicName: 'الإِنْشِقَاق', revelationType: 'Makki', juz: '30' },
    { number: 85, englishName: 'Levitation of Truth', transliteration: 'Al-Burūj', arabicName: 'الْبُرُوج', revelationType: 'Makki', juz: '30' },
    ...
    { number: 95, englishName: 'Flesh of Purity', transliteration: 'At-Tīn', arabicName: 'التِّين', revelationType: 'Makki', juz: '30' },
    ...
    { number: 98, englishName: 'Clear Proof', transliteration: 'Al-Bayyinah', arabicName: 'الْبَيِّنَة', revelationType: 'Madani', juz: '30' },
    { number: 99, englishName: 'Earthquake', transliteration: 'Az-Zalzalah', arabicName: 'الزَّلْزَلَة', revelationType: 'Madani', juz: '30' },
    ...
    { number: 102, englishName: 'Delusional Race', transliteration: 'At-Takāthur', arabicName: 'التَّكَاثُر', revelationType: 'Makki', juz: '30' },
    { number: 103, englishName: 'Time', transliteration: 'Al-ʿAṣr', arabicName: 'الْعَصْر', revelationType: 'Makki', juz: '30' },
    { number: 104, englishName: 'The Defamer', transliteration: 'Al-Humazah', arabicName: 'الْهُمَزة', revelationType: 'Makki', juz: '30' },
    { number: 105, englishName: 'Might of Ignorance', transliteration: 'Al-Fīl', arabicName: 'الْفِيل', revelationType: 'Makki', juz: '30' },
    { number: 106, englishName: 'The Shark', transliteration: 'Quraysh', arabicName: 'قُرَيْשׁ', revelationType: 'Makki', juz: '30' },
    ...
    { number: 111, englishName: 'Fiber of Purity', transliteration: 'Al-Masad', arabicName: 'الْمَسَد', revelationType: 'Makki', juz: '30' },
