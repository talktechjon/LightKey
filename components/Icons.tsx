...
export const FilmProjectorIcon = ({ className = "h-5 w-5" }: { className?: string }) => (
...
export const PlaylistPauseIcon = () => (
...
// From CustomAnimationControls
export const EyeIconSimple = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
...
export const CowIcon = () => (
    <span className="flex items-center justify-center w-full h-full text-lg leading-none">🐄</span>
);

export const MobiusIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M7.5 15.5c-3.5-1.5-4.5-4-4.5-5.5s1-4 4.5-5.5 8.5 0 12 1.5 4.5 4 4.5 5.5-1 4-4.5 5.5-8.5 0-12-1.5z" />
